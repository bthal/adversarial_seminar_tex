...
Note the similarities to FGSM, by using \(S=\{\eta \mid \lVert \eta \rVert \leq \delta\}\), we obtain its maximization problem. FGSM is therefore a specific method to tackle this general formulation.
