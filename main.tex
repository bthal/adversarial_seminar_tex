...
Hidden Trigger Backdoor Attacks~\cite{saha2020hidden} & White-box & Poisoning & Targeted & - \\
...
For optimisation, two steps are iterated: First, a gradient step to minimize x-v feature space distance("forward step"), then a step towards b to minimize x-b pixel distance ("backwards step").
%\todo{FAIL graphic - similar}

%\subsubsection{Clean-Label Backdoor Attacks}
\subsubsection{Hidden Trigger Backdoor Attacks}
...
\begin{figure}[t]
    \centering
    \includegraphics[height=6cm]{adversarial_dataset}
