...
\begin{frame}
  ...
  \begin{itemize}
      \item include the nonlinearity hypothesis!?
      \item ...
  \end{itemize}
...
\begin{frame}
  \frametitle{FGSM, linearity hypothesis}
  
  \begin{itemize}
      \item restructure: Include stuff from the discussion here?
      \item -> sigmoid/activation functions (linearity), FGSM step images
      \item backup slides: linear model, more formulas, 
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
      \item focus: versatility/generality
      \item explain: different loss peaks, but same value. Include image
  \end{itemize}
...
\begin{frame}
  \frametitle{[Transfer Attack intro]}
...
\begin{frame}
  ...
  \begin{itemize}
      \item []...
      \item if possible, more transferability improvements like momentum, ensemble
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
      \item []...
      \item more detail than in report?
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
      \item []...
      \item on each: include rough estimates on poison amount
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{[early poisoning]}
  
  \begin{itemize}
      \item []...
      \item focus on methods, assumptions
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
      \item []...
      \item stress: only one sample to be misclassified, but clean labels only
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{[hidden trigger]}
  
  \begin{itemize}
      \item []...
      \item REAALLY explain this well. Images too.
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
      \item []...
      \item Start with idea!!! and explain name (looking inwards to the target class).
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
      \item []...
      \item Move explanation approaches into FGSM?? Or someplace else?
  \end{itemize}
\end{frame}
...
%additionally: JSMA?, algos in backup slides
